...
//method is creating template keypad buttons list and template board button list, each cell have button and position assigned
    ...
    public void createBoardTemplate(List<Button> buttonList, List<Button> keypadButtons, SudokuGenerator generator) {
        int columnNumber = 1;
        int rowNumber = 1;
        ...
        for (int y=0; y<9; y++){
            ...
            creator.getButton().addActionListener(new ButtonInteract(creator.getButton(), this, generator));
